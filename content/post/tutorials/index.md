...
In his tutorial, Prof. Ölveczky presents an optional second-year course called "Logic for Distributed Systems" (10 ECTS credits), taught at University of Oslo, Department of Informatics during the spring semester. This is the only Formal Methods course offered in the BSc program of Programming and System Architecture, recommending as pre-requisites only logics and programming courses. The course employs [the Maude system](https://en.wikipedia.org/wiki/Maude_system) - an implementation of [Rewriting Logic](https://dl.acm.org/doi/10.5555/647199.718706) providing a specification language together with a simulation and model checking tool for system verification. Peter explains during the tutorial how he uses Maude to introduce distributed systems protocols and analyse them. The course is based on Prof. Ölveczky's book, ["Designing Reliable Distributed Systems"](https://link.springer.com/book/10.1007/978-1-4471-6687-0). The course attracts 20-40 students every year and the feedback is very good. The course demonstrates that students understand temporal logic quite well and can model complicated distributed protocols fairly easily. The theoretical part (presented in the first part of the course) is the only one that students seem to struggle with slightly. Maude and the associated textbook are much appreciated by students.

While the BSc program does not offer other Formal Methods courses, the MSc program offers a follow-up course using Maude on real-time and probabilistic systems, modeling and analyzing “verified” published network protocols, meta-programming, defining the semantics of programming languages in Maude, as well as applications of Maude in, e.g., systems biology. Courses on model checking and “models of concurrency” are also offered. 
